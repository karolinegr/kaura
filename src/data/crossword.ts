...
export const WORDS: Entry[] = [
  ...
  { dir: 'down', row: 0, col: 4, answer: 'GUIJARRAZO', clue: 'Um gol lindíssimo ⚽' },
  ...
  { dir: 'across', row: 4, col: 3, answer: 'LAURA', clue: 'O amor da vida da Karol 💚' },
  ...
  { dir: 'across', row: 12, col: 0, answer: 'HAAS', clue: 'Loiry 🏃🏼‍♀️' },
]
